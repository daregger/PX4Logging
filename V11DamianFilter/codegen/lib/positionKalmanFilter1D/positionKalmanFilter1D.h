...
extern void positionKalmanFilter1D(const real32_T A[9], const real32_T B[3], const real32_T C[3], real32_T x_aposteriori[3], real32_T P_aposteriori[9], real32_T u, real32_T z, uint8_T gps_update, const real32_T Q[9], real32_T R, real32_T thresh, real32_T decay);
#endif
