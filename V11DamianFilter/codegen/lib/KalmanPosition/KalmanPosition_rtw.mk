...
MODEL                = KalmanPosition
MODULES              = KalmanPosition_initialize.c KalmanPosition_terminate.c KalmanPosition.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = KalmanPosition_rtw.mk
...
MODELLIB                  = KalmanPosition.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = KalmanPosition_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);H:\0000_SAMA_PIXHAWK\06_Logging\V11DamianFilter\codegen\lib\KalmanPosition
